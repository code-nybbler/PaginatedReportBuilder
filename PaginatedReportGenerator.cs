...
namespace PaginatedReportGenerator
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Paginated Report Generator"),
        ExportMetadata("Description", "Generates a paginated report based off a selected D365 form"),
    ...
    public class PaginatedReportGenerator : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new PaginatedReportGeneratorControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public PaginatedReportGenerator()
        {
